...
var undefinedFields = {
  ...
  defined: undefined,
  v:0};
var simpleRecordWithCircularRef = {
  name:"myservice",
  pid:123,
  hostname:"example.com",
  level:30,
...
describe('A PrettyStream', function(){
  ...
  it('should print functions as [Function]', function () {
    var prettyStream = new PrettyStream({useColor: false});
    var result = prettyStream.formatRecord(funcFields);
    result.should.equal('[2012-02-08T22:56:52.856Z]  INFO: myservice/123 on example.com: My message (func=[Function])\n');
  })
